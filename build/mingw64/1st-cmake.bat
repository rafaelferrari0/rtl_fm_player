...
cmake ..\..\ -G "Unix Makefiles" -D C_INCLUDE_PATH="/%MINGW_HOMEFW%x86_64-w64-mingw32/include" -D LIBRARY_PATH="/%MINGW_HOMEFW%x86_64-w64-mingw32/lib" -D CMAKE_MAKE_PROGRAM="/%MINGW_HOMEFW%bin/mingw32-make.exe" -D CMAKE_C_COMPILER="/%MINGW_HOMEFW%bin/x86_64-w64-mingw32-gcc.exe"
