...
typedef enum _TBMPDetectionMethod
{
	dmPeaks = 0,
	dmAutoCorrelation = 1
} TBMPDetectionMethod;
...
typedef enum _TFFTGraphParamID
{
	gpFFTPoints = 1,
	gpGraphType,
	gpWindow,
...
typedef enum  _TCallbackMessage
{
